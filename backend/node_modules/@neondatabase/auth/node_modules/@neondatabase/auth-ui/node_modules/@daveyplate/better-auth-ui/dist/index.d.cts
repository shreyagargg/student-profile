...
declare function AccountView({ className, classNames, localization: localizationProp, path: pathProp, pathname, view: viewProp, hideNav, showTeams }: AccountViewProps): react_jsx_runtime.JSX.Element | null;
...
declare function AuthView({ className, classNames, callbackURL, cardHeader, cardFooter, localization, path: pathProp, pathname, redirectTo, socialLayout: socialLayoutProp, view: viewProp, otpSeparators }: AuthViewProps): react_jsx_runtime.JSX.Element;
...
interface CreateTeamDialogProps extends ComponentProps<typeof Dialog> {
    classNames?: SettingsCardClassNames;
    localization?: AuthLocalization;
    refetch?: Refetch;
 ...
 */
declare function CreateTeamDialog({ classNames, localization: localizationProp, refetch, organizationId, onOpenChange, ...props }: CreateTeamDialogProps): react_jsx_runtime.JSX.Element;
...
declare function DeleteTeamDialog({ classNames, team, localization: localizationProp, refetch, onOpenChange, ...props }: DeleteTeamDialogProps): react_jsx_runtime.JSX.Element;
...
interface OrganizationInvitationsCardProps extends SettingsCardProps {
    slug?: string;
    emptyState?: ReactNode;
}
declare function OrganizationInvitationsCard({ className, classNames, localization: localizationProp, slug: slugProp, emptyState, ...props }: OrganizationInvitationsCardProps): react_jsx_runtime.JSX.Element | null;
 ...
 */
declare function TeamCell({ className, classNames, team, localization, canDelete, canUpdate, refetch }: TeamCellProps): react_jsx_runtime.JSX.Element;
 ...
 */
interface TeamsCardProps extends SettingsCardProps {
    organizationId: string;
}
declare function TeamsCard({ className, classNames, localization, organizationId, ...props }: TeamsCardProps): react_jsx_runtime.JSX.Element;
...
declare function UpdateTeamDialog({ classNames, team, localization: localizationProp, refetch, onOpenChange, ...props }: UpdateTeamDialogProps): react_jsx_runtime.JSX.Element;
...
declare function UserTeamCell({ className, classNames, team, localization, refetch }: UserTeamCellProps): react_jsx_runtime.JSX.Element;
...
declare function UserTeamsCard({ className, classNames, localization }: UserTeamsCardProps): react_jsx_runtime.JSX.Element;
