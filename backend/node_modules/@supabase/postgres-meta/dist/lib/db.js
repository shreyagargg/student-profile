...
const poolerQueryHandleError = (pgpool, sql, parameters) => {
    return Sentry.startSpan({ op: 'db', name: 'poolerQuery' }, () => new Promise((resolve, reject) => {
        let rejected = false;
...
export const init = (config) => {
    return Sentry.startSpan({ op: 'db', name: 'db.init' }, () => {
        ...
        return {
            async query(sql, { statementQueryTimeout, trackQueryInSentry, parameters } = { trackQueryInSentry: true }) {
