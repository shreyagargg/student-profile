...
export const postgresColumnCreateSchema = Type.Object({
    ...
    default_value_format: Type.Optional(Type.Union([Type.Literal('expression'), Type.Literal('literal')])),
    is_identity: Type.Optional(Type.Boolean()),
    identity_generation: Type.Optional(Type.Union([Type.Literal('BY DEFAULT'), Type.Literal('ALWAYS')])),
...
const postgresIndexSchema = Type.Object({
    ...
    index_attributes: Type.Array(Type.Object({
...
export const postgresTablePrivilegesSchema = Type.Object({
    ...
    privileges: Type.Array(Type.Object({
        grantor: Type.String(),
        grantee: Type.String(),
