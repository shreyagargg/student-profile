...
function makeUseSuspenseQueryClient(db, client) {
    ...
    return function useSuspenseQueryClient(query, opts) {
        const useQueryResult = (0, react_common_1.useQueryInternal)(db.core, query, opts, 
...
function createFrameworkClient(db, user) {
    if (HydrationStreamProvider_tsx_1.isServer) {
        ...
        return new core_1.FrameworkClient({
    ...
    const client = new core_1.FrameworkClient({ db: db.core });
...
const InstantSuspenseProvider = (props) => {
    ...
    const clientRef = (0, react_1.useRef)(createFrameworkClient(props.db, props.user));
    if (HydrationStreamProvider_tsx_1.isServer) {
    ...
    const useSuspenseQuery = (0, react_1.useCallback)(HydrationStreamProvider_tsx_1.isServer
    ...
    return ((0, jsx_runtime_1.jsx)(exports.SuspsenseQueryContext.Provider, { value: contextValue, children: (0, jsx_runtime_1.jsx)(stream.Provider, { nonce: props.nonce, onFlush: () => {
                const toSend = [];
