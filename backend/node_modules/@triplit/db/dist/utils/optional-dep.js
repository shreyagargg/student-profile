const modules = {};
export function getOptionalDep(moduleName) {
    if (!modules[moduleName]) {
        throw new Error(`Optional dependency ${moduleName} has not been loaded or does not exist. You may need to install it.`);
    }
 ...
 */
export async function tryPreloadingOptionalDeps() {
...
//# sourceMappingURL=optional-dep.js.map