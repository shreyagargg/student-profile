 ...
 **/
export function createLazyEntity(entity, query, typeConverters) {
            ...
            if (prop === 'toJSON' ||
                ...
                return () => {
                    if (!cache.has('data')) {
                        ...
                        cache.set('data', dataConverter?.fromDB(entity.data) ?? entity.data);
                    }
            ...
            if (propStr === 'data') {
                ...
                if (inclusion) {
                    ...
                    if (cardinality === 'one') {
                        ...
                        value = (subEntities || []).map((v) => createLazyEntity(v, subquery, typeConverters));
                    }
                }
                else {
...
//# sourceMappingURL=lazy-entity.js.map