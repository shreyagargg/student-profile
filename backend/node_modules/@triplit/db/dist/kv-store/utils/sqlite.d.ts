...
export declare const STATEMENTS: Readonly<{
    /**
...
export declare const CHECKPOINT_RESTART = "PRAGMA wal_checkpoint(RESTART);";
export declare const CHECKPOINT_TRUNCATE = "PRAGMA wal_checkpoint(TRUNCATE);";
export declare function parseSqliteKvStoreOptions(options: SQLiteKVStoreOptions): Required<SQLiteKVStoreOptions>;
