 ...
 */
export type TypeInterface<TypeId extends string = string, Config extends TypeConfig = {}> = {
    type: TypeId;
    config?: Config;
};
/**
 ...
 */
export type OptionalType<T extends TypeInterface<any, any>> = T extends TypeInterface<infer TypeId, infer Config> ? // T & ... to keep additional props, probably a better way to do this
TypeInterface<TypeId, Config & {
    optional: true;
}> & Omit<T, keyof TypeInterface> : never;
/**
 ...
 * @template T - The type to transform
 */
export type NullableType<T extends TypeInterface<any, any>> = T extends TypeInterface<infer TypeId, infer Config> ? TypeInterface<TypeId, Config & {
    nullable: true;
}> : never;
/**
