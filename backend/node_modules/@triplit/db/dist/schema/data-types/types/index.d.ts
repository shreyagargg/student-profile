...
import { ALL_TYPES, DEFAULTABLE_TYPE_KEYS, PRIMITIVE_TYPE_KEYS } from '../constants.js';
 ...
 */
export type PrimitiveType = StringType<any> | NumberType<any> | BooleanType<any> | DateType<any>;
 ...
 * All data types
 */
export type DataType = PrimitiveType | SetType<PrimitiveType, any> | JsonType | RecordType<RecordProps<any, any>>;
