...
const BASE_OPERATIONS = ['isDefined'];
const COMPARISON_OPERATORS = ['=', '!=', '<', '>', '<=', '>='];
const COLLECTION_OPERATORS = ['has', '!has'];
const COLLECTION_ITEM_OPERATORS = ['in', 'nin'];
...
const SET_OPERATIONS = prefixOperations([...BASE_OPERATIONS, ...COLLECTION_OPERATORS], SET_OP_PREFIX);
...
const JSON_OPERATIONS = Array.from(new Set([
...
export function prefixOperations(operations, prefix) {
    return operations.map((op) => `${prefix}${op}`);
}
