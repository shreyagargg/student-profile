...
export class Schema {
     ...
     */
    static Id = (options = { format: 'nanoid' }) => {
    ...
    static RelationMany = (collectionName, query) => ({
        query: {
            collectionName,
            ...query,
        },
    ...
    //  * @param query - the query to filter the related collection
    //  */
    static RelationOne = (collectionName, query) => ({
        query: {
            collectionName,
            ...query,
        },
     ...
     * @param query - the query to filter the related collection
     */
    static RelationById = (collectionName, entityId) => ({
        query: {
            collectionName,
            where: [['id', '=', entityId]],
        },
