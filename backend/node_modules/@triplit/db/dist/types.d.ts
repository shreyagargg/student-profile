...
export type WritePermissionCheck = (storage: KVStoreOrTransaction, delta: Delta, operation: PermissionWriteOperations) => Promise<void>;
export type EntityChangeValidator = (collection: string, change: Change, options: {
